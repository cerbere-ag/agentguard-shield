...
const runLines: Line[] = [
  ...
  [{ t: '{"event": "signed_decisions_enabled", "level": "info"}', c: dim }],
  [{ t: '{"mode": "memory", "event": "atomic_budget_manager_enabled"}', c: dim }],
  [
    {
  ...
  [],
  [{ t: "PHASE 1 - Travail naturel de l'agent (taches legitimes)", c: amb }],
  [],
  ...
  [{ t: "[CERBERE] " }, { t: "ALLOW", c: allow }, { t: " -> [creneau libre le 2026-09-12 a 15h]" }],
  [],
  [
    { t: "[AGENT] ", c: dim },
  ...
  [],
  [{ t: "PHASE 2 - Tentative d'action malveillante (injection / abus)", c: amb }],
  [],
  [
    { t: "[AGENT] ", c: dim },
    {
  ...
  [],
  [{ t: "TERMINE", c: amb }],
  [{ t: "-> Audit Trail: 4 actions autorisees, 2 actions bloquees.", c: dim }],
];
      ...
      <section className="wrap grid items-center gap-14 py-20 md:py-24 lg:grid-cols-[1.15fr_.85fr]">
        ...
        <Reveal className="border border-line-black p-5.5 font-mono text-[13px] text-paper/55">
          ...
          {[
            ...
            <div
              key={k}
              className={`flex justify-between py-1.5 ${i === 0 ? "" : "border-t border-line-black"}`}
            >
              <span>{k}</span>
        ...
        <div className="wrap">
          ...
          <div className="mt-12 grid gap-px border border-line-black bg-line-black sm:grid-cols-2 lg:grid-cols-4">
            {plans.map((p) => (
              <Reveal
                key={p.name}
                className={`flex flex-col p-7 ${p.featured ? "border-t-2 border-amber bg-[oklch(0.17_0.004_60)]" : "bg-ink"}`}
              >
      ...
      <footer className="bg-amber text-coal">
        <div className="px-5 pb-10 pt-20 text-center">
          <div className="relative mx-auto mb-2 size-[220px] overflow-hidden shadow-[0_20px_50px_oklch(0.19_0.008_45/0.28)]">
            <img src={logo.url} alt="Cerbere AG guardian logo" className="size-full object-cover" />
        ...
        <div className="border-t border-coal/20">
          <div className="wrap flex flex-wrap items-center justify-between gap-3.5 py-5">
            <div className="flex flex-wrap gap-5 font-mono text-[13px]">
              <a href={GITHUB} target="_blank" rel="noopener" className="opacity-75 hover:opacity-100">
                GitHub
              </a>
              ...
              <a href="mailto:christopher-ag@cerbereag.site" className="opacity-75 hover:opacity-100">
                Contact
              </a>
            </div>
